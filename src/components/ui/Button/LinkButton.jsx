...
function LinkButton({ text, onClick, href, target }) {
  return (
    <>
      <a href={href} onClick={onClick} target={target} className="relative inline-flex items-center justify-center px-5 py-[5px] overflow-hidden transition duration-300 rounded-full shadow-xl group cursor-pointer text-sm md:text-base">
        ...
        <span className="relative text-white font-nunito font-light md:font-normal w-max text-sm">{text}</span>
