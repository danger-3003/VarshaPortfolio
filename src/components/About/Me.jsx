...
function Me()
{
    return(
        <>
            <div className="flex items-center justify-center flex-col-reverse sm:flex-row pt-20 p-5 md:p-10 lg:p-20 lg:pb-10">
                ...
                <div className="w-[50vw] sm:w-[30vw] lg:basis-[30%] mb-10 sm:mb-0 sm:mx-3 lg:mx-5">
                    <img src={Profile} alt="Profile photo" className="w-full"/>
                </div>
            </div>
        </>
    )
