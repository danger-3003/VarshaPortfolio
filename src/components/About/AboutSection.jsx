...
function AboutSection() {
  ...
  return (
    <>
      <div id="aboutSection" className='w-full relative flex items-center justify-center flex-col pb-16 pt-24 md:py-40 px-5 sm:px-8 md:px-10'>
          ...
          <div className='w-full flex items-center justify-center flex-col-reverse md:flex-row gap-10 lg:gap-32'>
            <div className='sm:basis-[60%] lg:basis-2/3 flex items-start justify-start flex-col gap-7 lg:gap-10'>
              ...
              <Text data-aos="fade-right" data-aos-delay="100" className="">
                Hi there! I'm Hima Varsha, a passionate <span className='font-semibold bg-gradient-to-r from-[#AC52F2] to-[#D11C9F] bg-clip-text text-transparent w-max'>UI/UX Designer</span> and <span className='font-semibold bg-gradient-to-r from-[#AC52F2] to-[#D11C9F] bg-clip-text text-transparent w-max'>Creative Professional </span>
