  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center">
        <div
          className="max-w-[70rem] w-full flex flex-col items-center justify-center pb-10 py-20 px-5 sm:px-8 md:px-10 overflow-x-hidden"
        >
          <div className='flex items-start justify-center flex-col gap-7 lg:gap-10 pt-6'>
            <div
              className={`flex items-center justify-center w-full rounded-lg sm:rounded-xl lg:rounded-2xl `}
            >
              <img src={project.img} alt={project.heading} className="w-full max-w-[40rem]" />
            </div>
            <h1 className="font-nunito font-semibold pointer-events-none text-3xl md:text-4xl lg:text-5xl">
              {project.heading}
            </h1>
            <div className='flex items-start justify-start flex-col gap-3 bg-slate-100 dark:bg-[#1f1f21] p-5 md:p-7 rounded-lg sm:rounded-xl lg:rounded-2xl border-l-4 border-primary-400'>
